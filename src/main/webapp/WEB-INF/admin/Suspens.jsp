    ...
    <div class="row">
     ...
     <div class="col-md-12">
      ...
      <thead>
          ...
          <th class="hider">Description <span class="js-sorter-desc     glyphicon glyphicon-chevron-down pull-right"></span> <span class="js-sorter-asc     glyphicon glyphicon-chevron-up pull-right"></span> </th>
          ...
          <th class="hider">Date résolution planifié <span class="js-sorter-desc     glyphicon glyphicon-chevron-down pull-right"></span> <span class="js-sorter-asc     glyphicon glyphicon-chevron-up pull-right"></span> </th>
          <th class="hider">Date résolution réelle  <span class="js-sorter-desc     glyphicon glyphicon-chevron-down pull-right"></span> <span class="js-sorter-asc     glyphicon glyphicon-chevron-up pull-right"></span> </th>
          <th class="hider">Impacts  <span class="js-sorter-desc     glyphicon glyphicon-chevron-down pull-right"></span> <span class="js-sorter-asc     glyphicon glyphicon-chevron-up pull-right"></span> </th>
           <th class="hider">Décisions  <span class="js-sorter-desc     glyphicon glyphicon-chevron-down pull-right"></span> <span class="js-sorter-asc     glyphicon glyphicon-chevron-up pull-right"></span> </th>
...
<th ><input class="js-filter  form-control" type="text" value="" id="dateRlFilter"></th>
      ...
      <tbody class="tb">
            ...
            <c:forEach items="${pts}" var="pts" >
						<tr>
                                                    <td id="tdTable" class="titre">${pts.pointSusDescrip}</td>
							<td id="tdTable" class="stat">${pts.pointSusStatut}</td>
                                                        <td id="tdTable">${pts.utilisateur.utilisateurNom}</td>
							<td id="tdTable" class="prio">${pts.pointSusPriorite}</td>
							<td id="tdTable">${pts.pointSusCreation}</td>
							<td id="tdTable">${pts.pointSusResPlan}</td>
							<td id="tdTable">${pts.pointSusResReal}</td>
                                                        <td id="tdTable" class="commentaire">${pts.pointSusImpacts}</td>
                                                        <td id="tdTable" class="commentaire">${pts.pointSusDecis}</td>
                                                        <td style="min-width: 0px" id="tdTable"><p data-placement="top" data-toggle="tooltip" title="Edit"><button class="btn btn-primary btn-xs" id="modif" data-title="Edit" data-toggle="modal" data-target="#edit" data-id="${pts.idPointSus}"><span class="glyphicon glyphicon-pencil"></span></button></p></td>
                                                        <td style="min-width: 0px" id="tdTable"><p data-placement="top" data-toggle="tooltip" title="Delete"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" data-id="${pts.idPointSus}" id="del"><span class="glyphicon glyphicon-trash"></span></button></p></td>
...
<div class="modal fade" id="ajout" tabindex="-1" role="dialog" aria-labelledby="ajout" aria-hidden="true">
    ...
    <div class="modal-content">
             <form method="post" action="ajouterPtSuspens">  
        <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
        <h4 class="modal-title custom_align" id="Heading">Ajouter point en suspens</h4>
      </div>
          <div class="modal-body">
          <div class="form-group">
              <label for="inputNomMatiere">Description</label>
...
<input type="text" class="form-control " name="DateCreation" id="datepicker" />
        ...
        <input type="text" name="DateClotureReelle" class="form-control " id="datepicker2" />
              ...
              <div class="form-group">
        <label for="inputNomMatiere">Impacts</label>
        
        <input class="form-control "  id="chantier" type="text" name="impact">
        </div>
              <div class="form-group">
        <label for="inputNomMatiere">Decisions</label>
        
        <input class="form-control "  id="chantier" type="text" name="decision">
        </div>
...
<input type="text" class="form-control " name="DateCreation" id="datepickermodif" />
    ...
    var myAction;
     ...
     myAction = $(this).data('id');
                            document.getElementById('updateModalForm').setAttribute("action", "updatePtSuspens/"+myAction);
});
        </script>
    ...
    document.getElementById("suppression").onclick = function () {
        location.href = "deletePtSuspens/"+myActionId;
    };
</script>
