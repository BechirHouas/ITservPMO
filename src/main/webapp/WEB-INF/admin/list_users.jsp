...
<div class="container bootstrap snippet">
         ...
         <div class="main-box no-header clearfix">
                <div class="main-box-body clearfix">
                    <div class="table-responsive" style="max-height: 420px ; overflow-y: scroll">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <c:choose>
                                        <c:when test="${(u.utilisateurEtat eq 1) or (u.utilisateurEtat eq 2)}">
  ...
  <div class="modal fade" id="add" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <select name="comptes" class="form-control" multiple>
...
document.getElementById('editComptesact').onchange = function() {
    document.getElementById('editComptes').disabled = !this.checked;
};
</script>
