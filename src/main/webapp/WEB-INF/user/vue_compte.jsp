		...
		<div class="col-lg-12" >
                ...
                <div class="row">
                   ...
                   <div class="panel panel-blue">
					...
					<div class="panel-body" style="min-height: 400px; max-height: 400px;overflow-y: scroll; background-color: #ffffff;">
						<ul id="list" class="todo-list">
                                                  <c:forEach items="${projets}" var="c" >
                                                    <li class="todo-list-item" style=" background-color: #30a5ff; height: 70px ;">
                                                 <div class="checkbox">
									<svg style="color: #ffffff" class="glyph stroked calendar"><use xlink:href="#stroked-calendar"/></svg>
                                                                        <a href="/PMOITserv/projet/${c.idProjet}"><label for="checkbox"> <h4 style="color:  #ffffff;">${c.projetLabel}</h4>  </label> <label for="checkbox" style="padding-left: 100px ; color:  #ffffff;"> <h5 style="color:  #ffffff;"> ${c.projetConcept}</h5> </label></a>
                                                                        
								</div>
                                                               
								<div class="pull-right action-buttons">
									<a href="#" data-toggle="modal" data-target="#ModalProjet" data-id="${c.idProjet}" id="updte"><svg  style="color: #ffffff" class="glyph stroked pencil"><use xlink:href="#stroked-pencil"></use></svg></a>
									<a href="#" class="trash" data-toggle="modal" data-target="#ModalSupp" data-id="${c.idProjet}" id="del"><svg style="color: #ffffff"class="glyph stroked trash"><use xlink:href="#stroked-trash"></use></svg></a>
								</div>
                                                        </li> 
                                                  </c:forEach>
